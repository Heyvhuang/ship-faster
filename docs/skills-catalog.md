...
| `supabase` | `service` | Database operations for Supabase: query, write, migration, logs, type generation. Write operations require confirmation; UPDATE/DELETE without WHERE refused. MCP optional. |

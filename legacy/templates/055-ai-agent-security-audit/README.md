# Template 055: AI Agent Security Audit
...
**Live Demo**: [https://h69-1774615391780.vercel.app](https://h69-1774615391780.vercel.app)
...
1. Enter template directory:
   ```bash
   cd templates/055-ai-agent-security-audit
   ```

# Template 020: AI Agent Security Audit
...
**Live Demo**: [https://h69-1771892432711.vercel.app](https://h69-1771892432711.vercel.app)
...
1. Enter template directory:
   ```bash
   cd templates/020-ai-agent-security-audit
   ```

# Template 054: AI Agent Memory Hygiene Service
...
**Live Demo**: [https://h9932-1774569628936.vercel.app](https://h9932-1774569628936.vercel.app)
...
1. Enter template directory:
   ```bash
   cd templates/054-ai-agent-memory-hygiene-service
   ```
